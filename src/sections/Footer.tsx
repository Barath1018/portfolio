...
export const Footer = () => {
  ...
  const getIconClass = (iconType: string) => {
    switch (iconType) {
      ...
      case "mail":
        return "text-gray-400 group-hover:text-sky-400";
      default:
        return "text-gray-400 group-hover:text-white";
    }
  };

  const getTextClass = (iconType: string) => {
    switch (iconType) {
      case "github":
  ...
  return (
    <footer className="relative overflow-x-clip">
      <div className="absolute h-[600px] w-[1600px] bottom-0 left-1/2 -translate-x-1/2 bg-emerald-300/40 [mask-image:radial-gradient(50%_50%_at_bottom_center,black,transparent)] -z-10"></div>

              ...
              <div className="flex flex-col gap-4">
                {contactInfo.map((info) => (
                  <div key={info.label} className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-lg bg-[#c084f5] flex items-center justify-center">
                      {info.label === "Email" && (
            ...
            <Card className="p-5 sm:p-6 md:p-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <a
                  ...
                  download
                  className="mt-2 w-full px-4 py-3 rounded-xl bg-[#c084f5] text-gray-900 font-semibold text-sm flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
                >
            ...
            {status === "sent" ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <button
                  ...
                  className="w-full sm:w-auto mt-2 px-8 py-3 rounded-xl bg-[#c084f5] text-gray-900 font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-60"
                >

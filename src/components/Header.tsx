      ...
      <div className="w-full relative bg-white/10 backdrop-blur-sm shadow-md">
        <div className="flex justify-between items-center px-4 py-3 relative">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              onClick={() => setMobileLinksOpen((s) => !s)}
              className="p-1.5 rounded-full text-gray-300 hover:text-white md:hidden"
              aria-expanded={mobileLinksOpen}
              aria-label="Open links"
            >
              {/* link icon */}
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                <path d="M3.9 12a5 5 0 0 1 0-7.07l2.12-2.12a5 5 0 0 1 7.07 7.07l-1.06 1.06a1 1 0 0 1-1.41-1.42l1.06-1.06a3 3 0 1 0-4.24-4.24L6.95 6.34A3 3 0 0 0 11.19 10.6l1.06-1.06a1 1 0 0 1 1.41 1.42L12.6 12a5 5 0 0 1-8.7 0z"/>
              </svg>
            </button>
          ...
          {mobileLinksOpen && (
            <div ref={mobileMenuRef} className="md:hidden absolute right-4 top-full mt-2 bg-gray-900/80 backdrop-blur rounded-xl p-2 flex flex-col gap-2 z-50">
              <a href="https://github.com/Barath1018" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md text-gray-200 hover:bg-white/5">GitHub</a>
              <a href="https://linkedin.com/in/barath-senthil-933b03294/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md text-gray-200 hover:bg-white/5">LinkedIn</a>
              <a href="https://instagram.com/_barath_ob1t0" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md text-gray-200 hover:bg-white/5">Instagram</a>
              <a href="https://discord.com/users/barath_codex4" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md text-gray-200 hover:bg-white/5">Discord</a>
              <a href="mailto:barath.senthil1602@gmail.com" className="p-2 rounded-md text-gray-200 hover:bg-white/5">Email</a>
            </div>
          )}
        </div>
      </div>

...
if (typeof document !== 'undefined' && !document.getElementById(KEYFRAMES_ID)) {
  ...
  style.textContent = `
    @keyframes pc-holo-bg {
      ...
      25%  { background-position: 50% 50%,  25% 25%, center; }
      50%  { background-position: 50% 100%, 50% 50%, center; }
      75%  { background-position: 50% 50%,  75% 75%, center; }
      100% { background-position: 50% 0%,   90% 90%, center; }
    }
  `;
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const shineStyle: React.CSSProperties = {
    ...
    animation: 'pc-holo-bg 6s linear infinite',
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col items-start gap-1">
                    <div className="text-sm font-medium text-white leading-none">@{handle}</div>
                    <div className="text-xs text-white/60 leading-none">{status}</div>
                  </div>
                </div>
                <button
                  className="border border-white/20 rounded-lg px-3 py-1.5 text-[10px] font-semibold text-white cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/50 hover:bg-white/10 hover:-translate-y-px"
            ...
            >
              <div className="w-full absolute flex flex-col items-center" style={{ top: '1.8em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-sans font-bold m-0 tracking-tight text-center"
                  style={{
                    fontSize: 'min(6svh, 2.6em)',
                    color: '#ffffff',
                ...
                <p
                  className="font-normal whitespace-nowrap mx-auto"
                  style={{
                    marginTop: '4px',
                    fontSize: '15px',
